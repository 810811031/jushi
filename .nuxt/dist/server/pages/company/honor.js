...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/company/honor.vue?vue&type=template&id=577f54de&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container",style:({ height: _vm.height + 'px' })},[_c('NavDom',{attrs:{"current":5,"white":"","mask":"","menu":_vm.menu}}),_vm._ssrNode(" "),_c('Logo',{attrs:{"dark":""}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"content\" data-v-577f54de>","</div>",[_vm._ssrNode("<div class=\"left\" data-v-577f54de>","</div>",[_vm._ssrNode("<div class=\"inside\" data-v-577f54de>","</div>",[_c('nuxt-link',{attrs:{"to":"introduction"}},[_c('p',[_vm._v("公司简介"),_c('span')])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"seniority"}},[_c('p',[_vm._v("公司资质"),_c('span')])]),_vm._ssrNode(" <p class=\"active\" data-v-577f54de>公司荣誉<span data-v-577f54de></span></p> "),_c('nuxt-link',{attrs:{"to":"recruit"}},[_c('p',[_vm._v("人才招聘"),_c('span')])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"contantUs"}},[_c('p',[_vm._v("联系我们"),_c('span')])]),_vm._ssrNode(" "),_c('nuxt-link',{attrs:{"to":"partner"}},[_c('p',[_vm._v("合作伙伴"),_c('span')])])],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"right\" data-v-577f54de>","</div>",[_vm._ssrNode("<div class=\"title alignCenter\" data-v-577f54de>我们有</div> "),_vm._ssrNode("<div class=\"html\" data-v-577f54de>","</div>",[_vm._ssrNode("<div class=\"sub-title\" data-v-577f54de>公司口号文案巴拉巴拉巴拉巴啦巴拉巴拉</div> "),_vm._ssrNode("<div class=\"__content__\" data-v-577f54de>","</div>",_vm._l((_vm.contents),function(item,index){return _c('TimeLime',{key:index,attrs:{"item":item,"active":index == _vm.contents.length - 1,"index":index},on:{"change":_vm.handleShow}})}),1)],2),_vm._ssrNode(" <div class=\"mask\""+(_vm._ssrStyle(null,null, { display: (_vm.show) ? '' : 'none' }))+" data-v-577f54de><img alt data-v-577f54de></div>")],2)],2),_vm._ssrNode(" "),_c('FooterDom',{attrs:{"item":_vm.result}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/company/honor.vue?vue&type=template&id=577f54de&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./self-components/timeline.vue?vue&type=template&id=0e9e21ef&scoped=true&
var timelinevue_type_template_id_0e9e21ef_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"__timeline__wrapper__"},[_vm._ssrNode("<span class=\"years\" data-v-0e9e21ef>"+_vm._ssrEscape(_vm._s(_vm.item.year)+"年")+"</span> <div"+(_vm._ssrClass(null,['line-wrapper', { 'active': _vm.active }]))+" data-v-0e9e21ef><div"+(_vm._ssrClass(null,['arc-wrapper', { 'active-wrapper': _vm.active }]))+" data-v-0e9e21ef><div"+(_vm._ssrClass(null,['arc-inslide', { 'active-inside': _vm.active }]))+" data-v-0e9e21ef></div></div> <div class=\"line-right\" data-v-0e9e21ef></div> <div class=\"line-bottom\" data-v-0e9e21ef></div> "+((_vm.index !== 0)?("<div class=\"line-left\" data-v-0e9e21ef></div>"):"<!---->")+"</div> "+(_vm._ssrList((_vm.item.array),function(group,i){return ("<div class=\"box-content\" data-v-0e9e21ef><span class=\"title\" data-v-0e9e21ef>"+_vm._ssrEscape(_vm._s(group.title))+"</span> <span class=\"description\" data-v-0e9e21ef>"+_vm._ssrEscape(_vm._s(group.descript))+"</span> "+((i !== _vm.item.array.length - 1)?("<span class=\"line-bottom\" data-v-0e9e21ef></span>"):"<!---->")+"</div>")})))])}
var timelinevue_type_template_id_0e9e21ef_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./self-components/timeline.vue?vue&type=template&id=0e9e21ef&scoped=true&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./self-components/timeline.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./self-components/timeline.vue?vue&type=script&lang=js&
 /* harmony default export */ var self_components_timelinevue_type_script_lang_js_ = (timelinevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./self-components/timeline.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  self_components_timelinevue_type_script_lang_js_,
  timelinevue_type_template_id_0e9e21ef_scoped_true_render,
  timelinevue_type_template_id_0e9e21ef_scoped_true_staticRenderFns,
  false,
  injectStyles,
  "0e9e21ef",
  "14ae2958"
...
// CONCATENATED MODULE: ./assets/data/honor.js
/* harmony default export */ var honor = ([{
  year: 2011,
  array: [{
    title: '荣誉名称',
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/company/honor.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var honorvue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./pages/company/honor.vue?vue&type=script&lang=js&
 /* harmony default export */ var company_honorvue_type_script_lang_js_ = (honorvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./pages/company/honor.vue



function honor_injectStyles (context) {
...
var honor_component = Object(componentNormalizer["a" /* default */])(
  company_honorvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  honor_injectStyles,
...
/* harmony default export */ var company_honor = __webpack_exports__["default"] = (honor_component.exports);
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("26dbf322", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("7686f6a5", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_timeline_vue_vue_type_style_index_0_id_0e9e21ef_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_timeline_vue_vue_type_style_index_0_id_0e9e21ef_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_timeline_vue_vue_type_style_index_0_id_0e9e21ef_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_timeline_vue_vue_type_style_index_0_id_0e9e21ef_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_timeline_vue_vue_type_style_index_0_id_0e9e21ef_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".__timeline__wrapper__[data-v-0e9e21ef]{width:1.15rem;display:inline-block;vertical-align:top;margin-right:.6rem}.__timeline__wrapper__ .years[data-v-0e9e21ef]{font-size:.14rem;color:#858c98;line-height:.2rem;margin-left:.1rem}.__timeline__wrapper__ .line-wrapper[data-v-0e9e21ef]{width:100%;height:.7rem;padding-left:.21rem;position:relative}.__timeline__wrapper__ .line-wrapper .arc-wrapper[data-v-0e9e21ef]{width:.24rem;height:.24rem;background-color:rgba(198,203,213,.3);border-radius:50%;display:flex;justify-content:center;align-items:center}.__timeline__wrapper__ .line-wrapper .arc-wrapper .arc-inslide[data-v-0e9e21ef]{width:.12rem;height:.12rem;background-color:#c6cbd5;border-radius:50%}.__timeline__wrapper__ .line-wrapper .line-left[data-v-0e9e21ef]{width:.81rem;height:2px;background-color:#c6cbd5;position:absolute;top:.11rem;left:-.54rem}.__timeline__wrapper__ .line-wrapper .line-right[data-v-0e9e21ef]{width:.82rem;height:2px;background-color:#c6cbd5;position:absolute;top:.11rem;left:.39rem}.__timeline__wrapper__ .line-wrapper .line-bottom[data-v-0e9e21ef]{width:2px;height:.56rem;background-color:#c6cbd5;position:absolute;bottom:0;left:.32rem}.__timeline__wrapper__ .line-wrapper .active-wrapper[data-v-0e9e21ef]{background-color:rgba(148,183,253,.3)!important}.__timeline__wrapper__ .line-wrapper .active-inside[data-v-0e9e21ef]{background-color:#94b7fd!important}.__timeline__wrapper__ .box-content[data-v-0e9e21ef]{width:100%;border:1px solid #c6cbd5;box-sizing:border-box;border-radius:.04rem;cursor:pointer;padding:.05rem;margin-bottom:.2rem;position:relative}.__timeline__wrapper__ .box-content .title[data-v-0e9e21ef]{font-size:.14rem;color:#666f7e;text-decoration:underline;display:block}.__timeline__wrapper__ .box-content .description[data-v-0e9e21ef]{width:1.05rem;display:block;line-height:.14rem;font-size:.12rem;color:#b8bbc1;white-space:pre-wrap;white-space:break-all}.__timeline__wrapper__ .box-content .line-bottom[data-v-0e9e21ef]{width:2px;height:.2rem;background-color:#c6cbd5;position:absolute;bottom:-.21rem;left:.32rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_honor_vue_vue_type_style_index_0_id_577f54de_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(54);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_honor_vue_vue_type_style_index_0_id_577f54de_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_honor_vue_vue_type_style_index_0_id_577f54de_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_honor_vue_vue_type_style_index_0_id_577f54de_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_honor_vue_vue_type_style_index_0_id_577f54de_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container[data-v-577f54de]{position:relative}.container[data-v-577f54de],.container .content[data-v-577f54de]{width:100%;height:100%}.container .content .left[data-v-577f54de]{width:4.84rem;height:100%;box-sizing:border-box;border-right:1px solid rgba(171,178,191,.3);position:relative;display:inline-block;vertical-align:top}.container .content .left .inside[data-v-577f54de]{position:absolute;top:50%;transform:translateY(-50%);box-sizing:border-box;padding-left:.95rem}.container .content .left .inside a[data-v-577f54de]{text-decoration:none;position:relative}.container .content .left .inside a[data-v-577f54de]:active,.container .content .left .inside a[data-v-577f54de]:hover,.container .content .left .inside a[data-v-577f54de]:link,.container .content .left .inside a[data-v-577f54de]:visited{text-decoration:none}.container .content .left .inside p[data-v-577f54de]{font-size:.18rem;color:#3e4045;line-height:.25rem;transition:all .2s linear;position:relative;margin-bottom:.36rem;box-sizing:border-box;padding-left:.2rem;cursor:pointer;font-weight:700;text-decoration:none}.container .content .left .inside p span[data-v-577f54de]{display:inline-block;width:0;height:.15rem;opacity:.4;position:absolute;bottom:-.05rem;left:0;transition:width .4s linear}.container .content .left .inside p:hover span[data-v-577f54de]{width:1.2rem;background-color:#dae0e9;height:.15rem;opacity:.6;bottom:-.05rem}.container .content .left .inside .active[data-v-577f54de]{font-size:.28rem}.container .content .left .inside .active span[data-v-577f54de]{width:1.2rem;background-color:#008ddc!important;height:.15rem!important;opacity:.6!important;bottom:-.1rem!important}.container .content .right[data-v-577f54de]{width:calc(100% - 5.7rem);height:100%;overflow:auto;box-sizing:border-box;display:inline-block;vertical-align:top;padding-top:.8rem;-webkit-animation:show-data-v-577f54de .3s;animation:show-data-v-577f54de .3s;position:relative}.container .content .right .title[data-v-577f54de]{font-size:.4rem;line-height:.56rem;color:#666f7e;margin-bottom:.4rem;padding-left:0!important}.container .content .right .html[data-v-577f54de]{font-size:.16rem;line-height:.22rem;color:#666f7e}.container .content .right .html .html-title[data-v-577f54de]{margin-bottom:.2rem}.container .content .right .html .html-content[data-v-577f54de]{margin-bottom:.6rem}@-webkit-keyframes show-data-v-577f54de{0%{transform:translateY(30px);opacity:0}}.container .alignCenter[data-v-577f54de]{text-align:center}.title[data-v-577f54de]{margin-bottom:.1rem!important}.sub-title[data-v-577f54de],.title[data-v-577f54de]{box-sizing:border-box}.sub-title[data-v-577f54de]{font-size:.24rem;color:#666f7e;line-height:.4rem;text-align:center}.__content__[data-v-577f54de]{width:100%;box-sizing:border-box;overflow-x:auto;white-space:nowrap;padding:.4rem .8rem 0}.mask[data-v-577f54de]{width:100%;height:100%;background-color:rgba(0,0,0,.6);position:absolute;left:0;top:0;display:flex;justify-content:center;align-items:center;-webkit-animation:show-data-v-577f54de .2s;animation:show-data-v-577f54de .2s}@keyframes show-data-v-577f54de{0%{transform:translateY(-30px);opacity:0}}.mask img[data-v-577f54de]{width:70%;min-height:400px;background-color:#e8e8e8}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
