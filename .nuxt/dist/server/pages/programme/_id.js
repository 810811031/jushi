...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_id_6e5376a1_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_id_6e5376a1_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_id_6e5376a1_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_id_6e5376a1_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_id_6e5376a1_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container[data-v-6e5376a1]{position:relative}.container[data-v-6e5376a1],.container .content[data-v-6e5376a1]{width:100%;height:100%}.container .content .left[data-v-6e5376a1]{width:4.84rem;height:100%;box-sizing:border-box;border-right:1px solid rgba(171,178,191,.3);position:relative;display:inline-block;vertical-align:top}.container .content .left .inside[data-v-6e5376a1]{position:absolute;top:50%;transform:translateY(-50%);box-sizing:border-box;padding-left:.95rem}.container .content .left .inside .p[data-v-6e5376a1]{display:block;text-decoration:none;font-size:.18rem;color:#3e4045;line-height:.25rem;transition:all .2s linear;position:relative;margin-bottom:.36rem;box-sizing:border-box;padding-left:.2rem;cursor:pointer;font-weight:700}.container .content .left .inside .p span[data-v-6e5376a1]{display:inline-block;width:0;height:.15rem;opacity:.4;position:absolute;bottom:-.1rem;left:0;transition:width .4s linear}.container .content .left .inside .p:hover span[data-v-6e5376a1]{width:1.2rem;background-color:#dae0e9;height:.15rem;opacity:.6;bottom:-.05rem}.container .content .left .inside .active[data-v-6e5376a1]{font-size:.28rem}.container .content .left .inside .active span[data-v-6e5376a1]{width:1.2rem;background-color:#008ddc}.container .content .right[data-v-6e5376a1]{width:calc(100% - 4.85rem);height:100%;overflow:auto;box-sizing:border-box;padding-left:1.15rem;display:inline-block;vertical-align:top;padding-top:1.1rem;padding-bottom:1rem;-webkit-animation:show-data-v-6e5376a1 .3s;animation:show-data-v-6e5376a1 .3s}.container .content .right .title[data-v-6e5376a1]{font-size:.4rem;line-height:.56rem;color:#666f7e;margin-bottom:.2rem}.container .content .right .SubTitle[data-v-6e5376a1]{font-size:.2rem;line-height:.3rem;color:#666f7e;margin-bottom:.3rem}.container .content .right .Cover[data-v-6e5376a1]{width:8rem;margin-bottom:.4rem}.container .content .right .html[data-v-6e5376a1]{width:calc(100% - 1.5rem);font-size:.16rem;line-height:.22rem;color:#666f7e}.container .content .right .html .html-title[data-v-6e5376a1]{margin-bottom:.2rem}.container .content .right .html .html-content[data-v-6e5376a1]{margin-bottom:.6rem}@-webkit-keyframes show-data-v-6e5376a1{0%{transform:translateY(30px);opacity:0}}@keyframes show-data-v-6e5376a1{0%{transform:translateY(30px);opacity:0}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/programme/_id.vue?vue&type=template&id=6e5376a1&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container",style:({ height: _vm.height + 'px' })},[_c('NavDom',{attrs:{"current":2,"white":"","mask":"","menu":_vm.menu}}),_vm._ssrNode(" "),_c('Logo',{attrs:{"dark":""}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"content\" data-v-6e5376a1>","</div>",[_vm._ssrNode("<div class=\"left\" data-v-6e5376a1>","</div>",[_vm._ssrNode("<div class=\"inside\" data-v-6e5376a1>","</div>",_vm._l((_vm.resultList),function(item,index){return _c('nuxt-link',{key:index,staticClass:"p",class:[{ 'active': _vm.$route.params.id - 1 == index }],attrs:{"to":("/programme/" + (index + 1))}},[_c('span'),_vm._v(_vm._s(item.Title))])}),1)]),_vm._ssrNode(" <div class=\"right\" data-v-6e5376a1><div class=\"title\" data-v-6e5376a1>"+_vm._ssrEscape(_vm._s(_vm.result.Title))+"</div> <div class=\"SubTitle\" data-v-6e5376a1>"+_vm._ssrEscape(_vm._s(_vm.result.SubTitle))+"</div> <img"+(_vm._ssrAttr("src",_vm.result.Cover))+" class=\"Cover\" data-v-6e5376a1> <div class=\"html\" data-v-6e5376a1>"+(_vm._s(_vm.result.Txt))+"</div></div>")],2),_vm._ssrNode(" "),_c('FooterDom',{attrs:{"item":_vm.init}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/programme/_id.vue?vue&type=template&id=6e5376a1&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/programme/_id.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  ...
  async asyncData(app) {
    ...
    const page = result[app.route.params.id - 1]; // 设置头部信息
  ...
  head() {
    return {
      ...
      meta: [{
        hid: 'description',
        name: 'description',
        content: this.result.SeoDescription
      }, {
        hid: 'keywords',
        name: 'keywords',
        content: this.result.SeoKeyword
      }]
    };
  },
...
// CONCATENATED MODULE: ./pages/programme/_id.vue?vue&type=script&lang=js&
 /* harmony default export */ var programme_idvue_type_script_lang_js_ = (_idvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/programme/_id.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  programme_idvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("2000a739", content, true, context)
};
