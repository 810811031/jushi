...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_43aa9362_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(62);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_43aa9362_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_43aa9362_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_43aa9362_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_43aa9362_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container[data-v-43aa9362],.container .cover[data-v-43aa9362],.container .swiper-container[data-v-43aa9362]{width:100%;height:100%}.container .cover[data-v-43aa9362]{overflow:hidden}.container .cover img[data-v-43aa9362]{width:100%;height:calc(100% + 1rem);transform:translateY(-.7rem);transition:transform .2s linear}.container .cover .active[data-v-43aa9362]{transform:translateY(0)}.container .active-point[data-v-43aa9362]{position:fixed;left:.4rem;top:50%;transform:translateY(-50%);z-index:9999}.container .active-point .active-point-block[data-v-43aa9362]{width:.26rem;height:.58rem;position:relative}.container .active-point .active-point-main[data-v-43aa9362]{width:.08rem;height:.08rem;background-color:#fff;border-radius:50%;display:block;transition:all .1s linear;position:absolute;left:0}.container .active-point .active-point-main span[data-v-43aa9362]{font-size:.14rem;color:#fff;position:absolute;right:-.24rem;top:50%;transform:translateY(-50%)}.container .active-point .active-point-normal[data-v-43aa9362]{display:block;width:.04rem;height:.04rem;background-color:#f7f7f7;opacity:.5;border-radius:50%;position:absolute;left:.02rem}.container .active-point .active-point-normal[data-v-43aa9362]:nth-of-type(2){top:.2rem}.container .active-point .active-point-normal[data-v-43aa9362]:nth-of-type(3){top:.38rem}.container .active-point .last[data-v-43aa9362]{height:.08rem}.container .active-point .active .active-point-main[data-v-43aa9362]{width:.26rem;height:.02rem;border-radius:0}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=43aa9362&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('swiper',{staticClass:"swiper-container",style:({ height: _vm.height + 'px' }),attrs:{"options":_vm.swiperOption,"id":"swiper"}},_vm._l((_vm.banners),function(item,index){return _c('swiper-slide',{key:index,staticStyle:{"overflow":"hidden"}},[_c('img',{staticStyle:{"width":"100%","height":"100%"},attrs:{"src":item.Src,"alt":item.Alt}})])}),1),_vm._ssrNode(" <div class=\"active-point\" data-v-43aa9362>"+(_vm._ssrList((_vm.banners),function(item,index){return ("<div"+(_vm._ssrClass(null,['active-point-block', { 'last': index == (_vm.banners.length - 1), 'active': _vm.activeIndex == index }]))+" data-v-43aa9362><span class=\"active-point-main\" data-v-43aa9362><span"+(_vm._ssrStyle(null,null, { display: (_vm.activeIndex == index) ? '' : 'none' }))+" data-v-43aa9362>"+_vm._ssrEscape(_vm._s('0' + (index + 1)))+"</span></span> "+((index !== (_vm.banners.length - 1))?("<span class=\"active-point-normal\" data-v-43aa9362></span> <span class=\"active-point-normal\" data-v-43aa9362></span>"):"<!---->")+"</div>")}))+"</div> "),_c('NavDom',{attrs:{"current":0,"touch":"","product":"","menu":_vm.menu},on:{"change":_vm.handleChange}}),_vm._ssrNode(" "),_c('Logo',{attrs:{"active":_vm.active}}),_vm._ssrNode(" "),_c('FooterDom',{attrs:{"item":_vm.result}})],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=43aa9362&scoped=true&
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("7fcbfe4e", content, true, context)
};
