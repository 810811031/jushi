<template>
    <div class="container"  :style="{ height: height + 'px' }">
        ...
        <div class="content">
            ...
            <div class="right">
                <div class="inside">
                    <div class="slide slide1" ref="slide1" @mouseenter="handleMouseEnter(1)" @mouseleave="handleMouseLeave(1)">
                        <div class="mask">
                    ...
                    <div class="slide slide2" ref="slide2" @mouseenter="handleMouseEnter(2)" @mouseleave="handleMouseLeave(2)">
                        <div class="mask">
                    ...
                    <div class="slide slide3" ref="slide3" @mouseenter="handleMouseEnter(3)" @mouseleave="handleMouseLeave(3)">
                        <div class="mask">
                    ...
                    <div class="slide slide4" ref="slide4" @mouseenter="handleMouseEnter(4)" @mouseleave="handleMouseLeave(4)">
                        <div class="mask">
